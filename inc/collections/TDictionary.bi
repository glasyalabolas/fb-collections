...
#macro template_dictionary( TCollection, TKey, TType... )
  ...
  type Dictionary( of TKey, of TType ) extends Collection( of TType )
    public:
      ...
      declare function findEntry( as TKey ) as KeyValuePair( of TKey, of TType ) ptr
      declare function findBucket( as TKey ) as LinkedList( of KeyValuePair( of TKey, of TType ) ) ptr
      
      declare function forEach( as Action( of TType ) ) byref as Dictionary( of TKey, of TType ) override
  ...
  '/
  sub Dictionary( of TKey, of TType ).setResizeThresholds( newSize as integer, lower as single, upper as single )
  ...
  sub Dictionary( of TKey, of TType ).rehash( newSize as integer )
    ...
    dim as LinkedList( of KeyValuePair( _
      ...
      newTable = callocate( newSize, sizeof( LinkedList( of KeyValuePair( of TKey, of TType ) ) ptr ) )
  ...
  function Dictionary( of TKey, of TType ).findBucket( aKey as TKey ) _
    ...
    return( _hashTable[ Key( of TKey )( aKey ).getHashCode() mod _size ] )
  end function
  
  '' Find a key-value pair in the internal hash table
  function Dictionary( of TKey, of TType ).findEntry( aKey as TKey ) as KeyValuePair( of TKey, of TType ) ptr
    dim as KeyValuePair( of TKey, of TType ) ptr entry = 0
  ...
  function Dictionary( of TKey, of TType ).add( aKey as TKey, byref aValue as TType ) byref as Dictionary( of TKey, of TType )
  ...
  function Dictionary( of TKey, of TType ).add( aKey as TKey, aValue as TType ptr ) byref as Dictionary( of TKey, of TType )
    addEntry( new KeyValuePair( of TKey, of TType )( aKey, aValue ), _hashTable, _size )
  ...
  '/
  function Dictionary( of TKey, of TType ).removeItem( aKey as TKey ) as TType ptr
    var aBucket = findBucket( aKey )
  ...
  function Dictionary( of TKey, of TType ).remove( aKey as TKey ) byref as Dictionary( of TKey, of TType )
    return( removeEntry( aKey ) )
  end function
  
  function Dictionary( of TKey, of TType ).forEach( anAction as Action( of TType ) ) byref as Dictionary( of TKey, of TType )
    for i as integer = 0 to _size - 1
      if( _hashTable[ i ] <> 0 ) then
  ...
  operator = ( lhs as Dictionary( of TKey, of TType ), rhs as Dictionary( of TKey, of TType ) ) as integer
    return( @lhs = @rhs )
  end operator
